                        ...
                        <tr style="border: none;">
                            ...
                            <td class="text-center" style="border: none;">
                                <div class="d-flex justify-content-center gap-1 assistance-actions" style="border: none;">
                                    <a href="{{ route('employees.edit', $employee->id) }}" class="btn p-1" style="border: none; background: none; color: #76AE91;" title="Edit Employee">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form action="{{ route('employees.destroy', $employee->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn p-1" style="border: none; background: none; color: #e74c3c;" onclick="return confirm('Are you sure?')" title="Delete Employee">
